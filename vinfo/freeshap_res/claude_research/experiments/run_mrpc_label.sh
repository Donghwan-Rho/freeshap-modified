#!/bin/sh
# A1 label-aware Shapley + data selection for MRPC (n=2000, val=408, seed=2026).
set -e
...
COMMON_ARGS="--seed 2026 --dataset_name mrpc --num_train_dp 2000 --val_sample_num 408 --tmc_iter 500"
...
python $SCRIPT_DIR/aggregate_label_summary.py \
    --dataset_name mrpc --seed 2026 --num_train_dp 2000 --val_sample_num 408 \
    --tmc_iter 500 --inv_lambda_ 1e-6 --eigen_lambda_ 1e-2 \
    --ranks 1 5 10 15 20 25 30

echo "[run_mrpc_label.sh] done"
