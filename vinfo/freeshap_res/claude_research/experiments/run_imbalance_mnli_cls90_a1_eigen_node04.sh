#!/bin/sh
# node04 — MNLI cls90_05_05 (label0 90/5/5) n=5000 valbal=1000.
# A1 eigen × 7 ONLY (r=1, 5, 10, 15, 20, 25, 30).
# INV is on node05; lrfshap eigen is on node01.  NTK already cached.
...
for R in 1 5 10 15 20 25 30; do
    echo "---------------------------------------------------------------"
    echo "[mnli-n5000-valbal] cls90_05_05 method=a1 eigen r=$R%"
    echo "---------------------------------------------------------------"
...
echo "[run_imbalance_mnli_cls90_a1_eigen_node04.sh] all done"
