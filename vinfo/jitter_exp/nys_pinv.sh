#!/bin/sh
# ============================================================
# pseudoinverse-Nystrom (nystrom_pinv) probe — rank sweep, llama (ntk_llama) 버전.
...
for S in $SEEDS; do
  for D in $DATASETS; do
    ...
    for R in 1 5 10 15 20 25 30; do
      ...
      STEM="llama_seed${S}_num2000_val${V}_nyspinv${R}.0_nyslam1e-02_nyseps1e-8_invlam1e-06_cholesky_float32_signFalse_earlystopTrue_tmc500"
      WSTEM="llama_seed${S}_num2000_val${V}_nyspinv${R}_lam1e-02_nyseps1e-8_cholesky_float32_signFalse_earlystopTrue_tmc500_poison10_ps${S}"
