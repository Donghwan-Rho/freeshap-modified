...
def get_poison_indices(dataset_name, poison_pct, poison_seed=2023):
    ...
    dataset.py uses random.seed(2023) and random.sample(range(nrows), num_to_flip)
...
def main():
    ...
    method_dir = "nystrom_lev" if _is_lev else ("nystrom_pinv" if _is_pinv else approximate)
